                        ...
                        <div class="widget box blue">
                         ...
                         <div id="table_datatabungan">
                            <?php
                                                ...
                                                $tabungan['tombol'] = '<a id="addtabungan" class="fg-button ui-state-default ui-corner-all" style="padding: 10px"><img src="assets/images/addicon.png" />Tambah Tabungan</a> 
                                                <a href="tariktunai" class="fg-button ui-state-default ui-corner-all"  style="padding: 10px; margin-top: 10px;"><img src="assets/images/addicon.png" />Tarik Tunai</a>';
                                                $tabungan['tabel_head'][] = array("","5%","No"); // id,width,title
                                                $tabungan['tabel_head'][] = array("nomor_nasabah","12%","Nomor Rekening");
                                                $tabungan['tabel_head'][] = array("tgl_dibuka","12%","Tanggal");
                                                $tabungan['tabel_head'][] = array("","20%","Nama nasabah");
                                                $tabungan['tabel_head'][] = array("","25%","Alamat");
                                                $tabungan['tabel_head'][] = array("","10%","Kota");
                                                $tabungan['tabel_head'][] = array("","15%","Manage");
