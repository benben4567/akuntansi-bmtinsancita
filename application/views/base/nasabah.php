                    ...
                    <div class="span12">
                        <div class="tabbable tabbable-custom boxless">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a href="#tabs-3" data-toggle="tab">Filter Nasabah</a></li>
                                <li><a href="#tabs-4" data-toggle="tab">Import Data Nasabah</a></li>
                            </ul>
                                                                        ...
                                                                        <div class="row-fluid">
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="3" type="text" size="16" class="m-wrap m-ctrl-medium date-picker input-large" name="tanggal_lahir">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                ...
                                                                                <div id="infomarital">
                                                                                    ...
                                                                                    <div class="control-group">
                                                                                        ...
                                                                                        <div class="controls">
                                                                                            <input tabindex="10" type="text" class="input-large" name="jumlah_anak"> Orang
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="12" type="text" class="input-large" name="nomor_npwp">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Nomor BPJS</label>
                                                                                    <div class="controls">
                                                                                        <input type="text" class="input-large" name="nomor_bpjs">
                                                                                    </div>
                                                                                </div>
                                                                                <h4>Waris</h4>
                                                                                <hr>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select tabindex="8" class="input-large" name="hubungan_waris" id="hubungan_waris">
                                                                        ...
                                                                        <div class="row-fluid">
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="alamat" id="alamat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">RT / RW</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="22" type="text" class="input-large" name="rtrw">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="24" type="text" class="input-large" name="kode_pos">
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="41" type="text" class="input-large" name="telpon_rumah">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Telpon kantor</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="42" type="text" class="input-large" name="telpon_kantor">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">HP</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="43" type="text" class="input-large" name="hp">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                        ...
                                                                        <div class="row-fluid">
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="nama_perusahaan" id="nama_perusahaan">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <select tabindex="35" class="input-large" name="bidang_pekerjaan">
                                                                                            <option value="0">----------------</option>
                                                                                            <option value="1">PNS/BUMN</option>
                                                                                            <option value="2">KARYAWAN SWASTA</option>
                                                                                            <option value="3">PEDAGANG</option>
                                                                                            <option value="4">UMKM & IRT</option>
                                                                                            <option value="5">KORPORASI</option>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Alamat</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="alamat_pekerjaan" id="alamat_pekerjaan">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Propinsi</label>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Kode Pos</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="24" type="text" class="input-large" name="kode_pos_pekerjaan">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="atasan_langsung" id="atasan_langsung">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Posisi / Jabatan</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="posisi_jabatan" id="posisi_jabatan">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                            ...
                                                                            <!-- <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    ...
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="usaha_saldoratarata" id="usaha_saldoratarata">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Jumlah karyawan</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="usaha_jlhkaryawan" id="usaha_jlhkaryawan">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Alamat</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="alamat_usaha" id="alamat_usaha">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Propinsi</label>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Kode Pos</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="24" type="text" class="input-large" name="kode_pos_usaha">
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="row-fluid">
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Nama</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="nama_kerabat" id="nama_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Hubungan</label>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Alamat</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="21" type="text" class="input-large" name="alamat_kerabat" id="alamat_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">RT / RW</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="32" type="text" class="input-large" name="rtrw_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Propinsi</label>
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Kode Pos</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="24" type="text" class="input-large" name="kode_pos_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="span6 ">
                                                                                ...
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Telpon rumah</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="41" type="text" class="input-large" name="telpon_rumah_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Telpon kantor</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="42" type="text" class="input-large" name="telpon_kantor_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">HP</label>
                                                                                    <div class="controls">
                                                                                        <input tabindex="43" type="text" class="input-large" name="hp_kerabat">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="control-group">
                                                                                    <label class="control-label">Email</label>
                                        ...
                                        <div class="span12">
                                            <form class="form-horizontal">
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="jenis_tabungan" id="jenis_tabungan">
                                                            <?php foreach ($jenis_tabungan as $row) { ?>
                                                                <option value="<?=$row['kode_produk'];?>"><?=$row['grouptabungan_nama'];?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label" for="">Dari Tanggal</label>
                                                    <div class="controls">
                                                        <input type="date" id="start_date" name="start_date">
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label" for="">Sampai Tanggal</label>
                                                    <div class="controls">
                                                ...
                                                <div class="control-group">
                                                    <div class="controls">
                                                        <button type="button" id="get_filter_nasabah" class="btn">Filter Data</button>
                                                    </div>
                                                    <div style="display:flex; justify-content: end; margin-top: 40px;">
                                                        <button type="button" id="print_filter_nasabah"><img src="<?=base_url()?>assets/images/print.png" width="20">Print</button>
                                                    </div>
                                                    <div id="table_filter_nasabah">
                                                        <table id="" width="100%" collapse border="1" style="margin-top:10px; border-collapse: collapse;">
                                                            <thead>
                                                                <tr>
                                                                    <th>No.</th>
                                                                    <th>Nomor Nasabah</th>
                                                            ...
                                                            <tbody id="filter_data_nasabah"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div style="display: flex; justify-content: center; margin-top: 20px;">
                                                <a href="<?=base_url()?>data/template_data_nasabah.xlsx" style="padding: 10px 15px; border-radius: 3px; background-color: green; color: #fff; text-decoration: none; margin-right: 5px;" download>Download Template</a>
                                                <a href="#myModal" role="button" data-toggle="modal" style="padding: 10px 15px; border-radius: 3px; background-color: green; color: #fff; text-decoration: none;">Import Data Nasabah</a>
                                            </div>

                                            <!-- Modal -->
                                            <form action="<?=base_url();?>base/nasabah/import_excel" method="post" enctype="multipart/form-data">
                                                <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                  <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    <h3 id="myModalLabel">Import Data Nasabah</h3>
                                                </div>
