    ...
    <!--[if IE 9]> <html lang="en" class="ie9"> <![endif]-->
        <!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
            <head>
                ...
                <!-- <link href="<?=base_url()?>assets/css/DT_bootstrap.css" rel="stylesheet" type="text/css" /> -->
            ...
            <![endif]-->	
                ...
                <!-- <script type="text/javascript" charset="utf-8">
                    ...
                    $('#example').dataTable({
                        "sDom": "<'row'<'span6'l><'span6'f>r>t<'row'<'span5'i><'span5'p>>"
                    });
                 });
                                ...
                                <div class="span12">
                                    <div class="tabbable tabbable-custom boxless">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a href="#tabs-4" id="tabs-d" data-toggle="tab">List Pembiayaan</a></li>
                                        </ul>
                                        <div class="tab-content">
                                                ...
                                                <form class="form-horizontal" id="form_pembiayaan" method="post">
                                                    <div class="span6 ">
                                                        <div class="control-group fm-req">
                                                            ...
                                                            <div class="controls">
                                                                <input name="nomor_rekening" tabindex="4" type="text" class="inp input-xlarge"> <a class="btn searchact"><i class="icon-search"></i></a>
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                            <label class="control-label">Nama</label>
                                                            <div class="controls">
                                                                <input name="nama" tabindex="5" type="text" class="input-xlarge">
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                        ...
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input name="kota" tabindex="7" type="text" class="input-xlarge">
                                                    ...
                                                    <div>
                                                        ...
                                                        <br/><br/>
                                                        <div class="ui-grid-footer ui-widget-header ui-corner-bottom pcariDatadetail" align="right"><button class="ui-state-default ui-corner-all"><img src="assets/images/printer.png"> Cetak</button>
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="tabs-2">
                                                <div class="widget box blue">
                                                    ...
                                                    <div id="table_datapembiayaan">
                                                        ...
                                                        $nasabah['option'][] = array("nomor_rekening","Nomor Rekening"); 
                                            ...
                                            <div class="tab-pane" id="tabs-3">
                                                <div class="widget box blue">
                                                    ...
                                                    <br/><br/>
                                                    <div class="ui-grid-footer ui-widget-header ui-corner-bottom pcariData" align="right">
                                                        <button class="ui-state-default ui-corner-all"><img src="assets/images/printer.png"> Cetak</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="tabs-4">
                                            ...
                                            <table width="100%" id="example" border="1" style="border-collapse: collapse;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Jumlah di Angsur</th>
                                                        <th>Sisa Angsuran</th>
                                                        <th>DL Angsuran(bulan ini)</th>
                                                        <th width="8%" align="center">act.</th>
                                                    </tr>
                                                </thead>
                                                <tbody id="list_pembiayaan">
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
