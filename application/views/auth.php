...
<head>
  ...
  <script type="text/javascript" src="<?= base_url()?>assets/js/jq/jquery-1.3.2.min.js"></script>
  <script type="text/javascript" src="<?= base_url()?>assets/js/jq/jquery-ui-1.7.2.custom.min.js"></script>
  <!--<?php $this -> load -> view( 'header' );?>-->
  <script type="text/javascript" src="<?= base_url()?>assets/js/auth.js"></script>
</head>
<body>
    <div id="logo" class="center">
        <img src="assets/img/logo.png" alt="BMT" width="100" style="border-radius: 10px; padding: 15px; background-color: #F7F7F7;" class="center" />
    </div>
  <div id="login">
  <p class="center"></p>
    <form>
      <div class="control-group">
        <div class="controls">
          <div class="input-prepend">
            <span class="add-on"><i class="icon-user"></i></span><input style="width: 100%;" name="username" id="input-username" class="inp" type="text" placeholder="Username" />
          </div>
        </div>
      </div>
      <div class="control-group">
        <div class="controls">
          <div class="input-prepend">
            <span class="add-on"><i class="icon-lock"></i></span><input style="width: 100%;" name="password" id="input-password" class="inp" type="password" placeholder="Password" />
          </div>
        </div>
      </div>
       <!-- <div class="control-group">
  ...
  <div id="login-copyright">
    <p align="center">APLIKASI KSP SYARIAH</p>
  </div>
