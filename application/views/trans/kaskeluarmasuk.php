                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   ...
                                   <li class=""><a href="#tabs-2" data-toggle="tab">Import Transaksi</a></li>
                                </ul>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div style="display: flex; justify-content: center; margin-top: 20px;">
                                                <a href="<?=base_url()?>data/template_traksaksi.xlsx" style="padding: 10px 15px; border-radius: 3px; background-color: green; color: #fff; text-decoration: none; margin-right: 5px;" download>Download Template</a>
                                                <a href="#myModal" role="button" data-toggle="modal" style="padding: 10px 15px; border-radius: 3px; background-color: green; color: #fff; text-decoration: none;">Import Data Transaksi</a>
                                            </div>

                                            <!-- Modal -->
                                            <form action="<?=base_url();?>trans/kaskeluarmasuk/import_excel" method="post" enctype="multipart/form-data">
                                                <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                  <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                    <h3 id="myModalLabel">Import Data Transaksi</h3>
                                                </div>
