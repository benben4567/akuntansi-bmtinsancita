...
class Tabungan extends CI_Controller {
	...
	function __construct()
	{
        ...
        $this->menuactsubB = "printTabungan";
    }
    ...
    function printTabungan()
    {
        ...
        $getData = $this->db->query("SELECT * FROM tb_tabungan WHERE tabungan_id=$tabungan_id")->row_array();
        $data['menunya'] = $this->authlib->loadMenu('0',$this->nama_group,$this->menuact,$this->menuactsubB);
        $data['tema'] = "";
        $data['idpeg'] = $this->session->userdata('username');
        $this->load->view('base/printTabungan',$data);
    }
