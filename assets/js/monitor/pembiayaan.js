...
function loadtrans(norekening){
   ...
   $('#tabs-d').click(function(){
    var isi = '';
    var nr  = 1;
    $.ajax({
        url: 'monitor/pembiayaan/table_list_pembiayaan',
        type: 'post',
        dataType: 'json',
        async : false,
        success: function(json){
            ...
            for(i = 0 ; i < json['alldata'].length; i++) {
            for(i = 0 ; i < json['ref_o'].length; i++) {
                isi += "<tr>"
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ nr +"</td>" 
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ json['alldata'][i].nama +"</td>" 
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ json['alldata'][i].nomor_rekening +"</td>" 
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ json['alldata'][i].grouppembiayaan_nama +"</td>" 
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ json['ref_o'][i].lunas +"</td>" 
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ json['alldata'][i].belum_lunas +"</td>" 
                + "<td style=\"border-top:1px solid #000\" align=\"center\">"+ json['alldata'][i].tgl_angsuran +"</td>" 
                + "</tr>";
                nr++;
            }
            }
            $('#list_pembiayaan').html(isi);
        }
    })
})
