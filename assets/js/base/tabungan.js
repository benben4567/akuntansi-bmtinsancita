    ...
    */
    ...
    function(hal,juml,json) {
        ...
        for(i = 0; i < json['alldata'].length; i++) {
            ...
            //
            managejab = "<img  class=\"cedt\" title=\"Edit\" src=\"assets/images/editicon.png\"/>&nbsp;&nbsp;|&nbsp;&nbsp;<img class=\"chps\" title=\"Hapus\" src=\"assets/images/delicon.png\"/>&nbsp;&nbsp;|&nbsp;&nbsp;<img class=\"cprint\" title=\"Cetak\" width=\"18\" src=\"assets/images/print.png\"/>";
            isi += "<tr style=\"vertical-align:top;\">"
            + "<td align=\"center\">" + (((hal - 1) * juml ) + (i + 1)) + "</td>"
            + "<td align=\"left\">" + json['alldata'][i].nomor_rekening + "</td>"
            + "<td align=\"left\">" + json['alldata'][i].tgl_dibuka + "</td>"
            ...
            + "<td style=\"display:none;\" align=\"center\">" + json['alldata'][i].tabungan_id + "</td>"
            + "</tr>";
        }
        return isi;
    },
    function domIsi() {
        ...
        $('.cprint').click(function(){
            ...
            jQuery.ajax({
                type:"POST",
                data: {tabungan_id : obj.tabungan_id},
                // dataType: 'json',
                url: "base/tabungan/printTabungan",
                success: function(){
                    message : 'success'
                }
            })
